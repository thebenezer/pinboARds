...
<body>
    ...
    include("header.php");
        ...
        <div class="create-pinboard">
            <ul class="create_list">
                <a href="./create1.php">Text Board</a>
                <a href="./create2.php">Scribble Pad</a>
                <a href="./create3.php">Image Board</a>
            </ul>
    ...
    <section class="pinboards-section">
        ...
        <div class="democards">
            <?php
            if($num_boards==0){
                echo '<p style="margin: auto;">You have no pinboARds yet. Click on the plus button to start creating.</p>';
            }
            else{
                    ...
                    if(!mysqli_stmt_prepare($stmt,$sql)){
                        ...
                        if(!mysqli_stmt_execute($stmt)){
                            ...
                            if($result->num_rows == 0){
                                ...
                                $row = $result->fetch_assoc();
                                echo ' <div class="card">';?>
                                            <div class="pin-card-img" style="background: url('./assets/saved_pins/<?php echo $pinboard['pid'];?>.png') no-repeat top;" ></div>
                                <?php  echo'<h3>Pinboard ID:'.$row['pid'].'</h3>
                                            <p>Scribble Board</p>
